export const APPWRITE_CONFIG = {
  ...
  // Functions
  BELVO_AUTH_FUNCTION_ID: import.meta.env.VITE_APPWRITE_BELVO_AUTH_FUNCTION_ID,
  BELVO_EXCHANGE_FUNCTION_ID: import.meta.env
    .VITE_APPWRITE_BELVO_EXCHANGE_FUNCTION_ID,
};
